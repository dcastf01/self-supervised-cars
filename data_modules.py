...
class FGVCAircraftDataModule(TemplateDataModule):
    ...
    def setup(self, stage=None):
        ...
        self.FGVCaircraft_trainclassifier=FGVCAircraftLoader(self.transform_fn_classifier,
                                                     self.data_dir, split="train")
    ...
    def trainclassifier_dataloader(self):
        return DataLoader(self.FGVCaircraft_trainclassifier, batch_size=self.batch_size,
                          shuffle=True,
                          num_workers=CONFIG.NUM_WORKERS,
                          pin_memory=True,
                          drop_last=False,
...
class Cars196DataModule(TemplateDataModule):
    ...
    def setup(self, stage=None):
        ...
        self.cars196_trainclassifier=Cars196Loader(self.transform_fn_classifier,
                                                        self.img_folder_train,
                                                        self.train_annos_mat,
                                                        self.root,
                                                        split="train"
    ...
    def trainclassifier_dataloader(self):
        return DataLoader(self.cars196_trainclassifier, batch_size=self.batch_size,
                          shuffle=True,
                          num_workers=CONFIG.NUM_WORKERS,
                          pin_memory=False,
                          drop_last=False,
